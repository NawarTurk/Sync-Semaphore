...
class CharStack {
	 ...
	 */
	public static final int MIN_SIZE = 7; // Minimum stack size __________________________________?
	public static final int MAX_SIZE = 32; // # of letters in the English alphabet + 6 _________________?
