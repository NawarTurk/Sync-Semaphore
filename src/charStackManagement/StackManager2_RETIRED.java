...
//
//public class StackManager2_RETIRED {
...
//	private static Semaphore mutexExtra = new Semaphore(-1);
//
...
//
//			for (int i = 0; i < StackManager2_RETIRED.iThreadSteps; i++) {
//				mutexExtra.P();
//				mutex.P();
//				try {
//					copy = stack.pop();
...
//
//			for (int i = 0; i < 2 * StackManager2_RETIRED.iThreadSteps; i++) {
//				mutexExtra.P();
//				mutex.P();
